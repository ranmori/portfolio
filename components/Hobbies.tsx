           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {HOBBIES.paintings.map((art) => (
                 ...
                 >
                    ...
                    >
                      <img src={art.image} alt={art.title} className="w-full h-full object-cover transition-all duration-700 group-hover:blur-[2px] group-hover:opacity-70" />
                    </MotionDiv>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-4 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <h4 className="text-xl font-bold text-base-content mb-1 drop-shadow-md bg-base-100/50 backdrop-blur-sm px-4 py-1 rounded-full">{art.title}</h4>
                        <span className="text-xs font-mono text-primary bg-base-100/80 backdrop-blur px-2 py-1 rounded border border-primary/20 mt-2">{art.style}</span>
                    </div>
                  ...
                  >
                      ...
                      <div className="card-body p-4 justify-center flex-1 min-w-0">
                          ...
                          <div className="mt-auto pt-2 flex">
                              <span className="badge badge-xs badge-ghost opacity-70 border-base-content/10">{book.category}</span>
                          </div>
                      </div>
                  </MotionDiv>
              ))}
